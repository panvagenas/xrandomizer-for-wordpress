    ...
    n.exports = function r(t, n, i) {
        ...
        1: [function (e, t, n) {
            ...
            u.prototype._parseError = function (e, t) {
                ...
                function w(e) {
                    ...
                    return n === "/" ? (this._temporaryBuffer = "", t.setState(E)) : n === "!" ? (t._emitToken({
                        type: "Characters",
                        data: "<!"
                    }), t.setState(x)) : (t._emitToken({type: "Characters", data: "<"}), e.unget(n), t.setState(p)), !0
                }
                ...
                function C(e) {
                    ...
                    return i === r.EOF ? (e.unget(i), t.setState(n)) : i === "-" ? (t._emitToken({
                        ...
                        type: "Characters",
                        data: "\ufffd"
                    }), t.setState(N)) : (t._emitToken({type: "Characters", data: i}), t.setState(N)), !0
                }
                ...
                function _(e) {
                    ...
                    return i === r.EOF ? (t._parseError("eof-in-script"), e.unget(i), t.setState(n)) : i === "-" ? (t._emitToken({
                        ...
                        type: "Characters",
                        data: "\ufffd"
                    }), e.commit()) : (t._emitToken({type: "Characters", data: i}), e.commit()), !0
                }
                ...
                function at(e) {
                    ...
                    if (i === r.EOF)t._currentToken.forceQuirks = !0, e.unget(i), t._parseError("eof-in-doctype"), t.setState(n), t._emitCurrentToken(); else if (!s(i))if (i === ">")t.setState(n), t._emitCurrentToken(); else {
                        if (["p", "P"].indexOf(i) > -1) {
                            var o = [["u", "U"], ["b", "B"], ["l", "L"], ["i", "I"], ["c", "C"]], u = o.every(function (t) {
                                return i = e.char(), t.indexOf(i) > -1
                            });
                            if (u)return t.setState(ft), !0
                        } else if (["s", "S"].indexOf(i) > -1) {
                            var o = [["y", "Y"], ["s", "S"], ["t", "T"], ["e", "E"], ["m", "M"]], u = o.every(function (t) {
                                return i = e.char(), t.indexOf(i) > -1
                            });
            ...
            function g() {
                ...
                },t.text = Object.create(t.base),t.text.start_tag_handlers = {"-default": "startTagOther"},t.text.end_tag_handlers = {
                    script: "endTagScript",
                    "-default": "endTagOther"
