...
namespace wsc_v000000_dev
{
	...
	class files extends dirs_files
	{
		...
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'wp_load'), func_get_args());
		}
		 ...
		 * @return string {@inheritdoc}
		 *
		 * @see \wsc_v000000_dev::mime_type()
		 * @inheritdoc \wsc_v000000_dev::mime_type()
		 */
		public function mime_type() // Arguments are NOT listed here.
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'mime_type'), func_get_args());
		}
		 ...
		 *
		 * @see \wsc_v000000_dev::mime_types()
		 * @inheritdoc \wsc_v000000_dev::mime_types()
		 */
		public function mime_types() // Arguments are NOT listed here.
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'mime_types'), func_get_args());
		}
		 ...
		 * @return array {@inheritdoc}
		 *
		 * @see \wsc_v000000_dev::textual_mime_types()
		 * @inheritdoc \wsc_v000000_dev::textual_mime_types()
		 */
		public function textual_mime_types() // Arguments are NOT listed here.
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'textual_mime_types'), func_get_args());
		}
		 ...
		 * @return array {@inheritdoc}
		 *
		 * @see \wsc_v000000_dev::compressable_mime_types()
		 * @inheritdoc \wsc_v000000_dev::compressable_mime_types()
		 */
		public function compressable_mime_types() // Arguments are NOT listed here.
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'compressable_mime_types'), func_get_args());
		}
		 ...
		 * @return array {@inheritdoc}
		 *
		 * @see \wsc_v000000_dev::binary_mime_types()
		 * @inheritdoc \wsc_v000000_dev::binary_mime_types()
		 */
		public function binary_mime_types() // Arguments are NOT listed here.
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'binary_mime_types'), func_get_args());
		}
		 ...
		 * @return array {@inheritdoc}
		 *
		 * @see \wsc_v000000_dev::cacheable_mime_types()
		 * @inheritdoc \wsc_v000000_dev::cacheable_mime_types()
		 */
		public function cacheable_mime_types() // Arguments are NOT listed here.
		{
			return call_user_func_array(array('\\wsc_v000000_dev', 'cacheable_mime_types'), func_get_args());
		}
		 ...
		 * @throws exception If invalid types are passed through arguments list.
		 *
		 * @see \deps_x_wsc_v000000_dev::abbr_bytes()
		 */
		 ...
		 *    Remember to use {@link \wsc_v000000_dev\strings\esc_refs()}
		 *
