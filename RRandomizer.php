 ...
 *
 */
require_once( plugin_dir_path( __FILE__ ) . 'admin/class-plugin-widget.php' );
 ...
 */
add_action( 'widgets_init', function (){register_widget( 'Plugin_widget' );} );
 ...
 */
add_filter( 'cron_schedules', array('Plugin_Name', 'addCron') );
add_action( 'Plugins_name_weekly_event_hook', array('Plugin_Name','cronJobAction') );
